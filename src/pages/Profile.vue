      ...
      <div class="col col-md-4 row-profile">
        <div class="row-2">
          <div class="profile">
            ...
            <a href="https://github.com/yonding" target="_blank"
              ><img
                src="@/assets/github_logo.png"
                alt="github_logo"
                id="githubImg"
            /></a>
            <a href="https://yonding.tistory.com/" target="_blank"
              ><img
                src="@/assets/tistory_logo.png"
                alt="tistory_logo"
                id="tistoryImg"
            /></a>
          </div>
      ...
      <div class="col col-md-8 row-info">
        <div class="row row-edu">
          ...
          <div class="col col-md-7 education">
            <h4>
              <a href="https://www.khu.ac.kr/" id="khuLink" target="_blank"
        ...
        <div class="row row-pub">
          <div class="col">
            <h2>PUBLICATIONS</h2>
            <a
              href="https://yonding.s3.ap-northeast-2.amazonaws.com/Apache+Calcite+Adapter+Architecture+for+Efficient+Query+Federation.pdf"
              target="_blank"
              id="kccPaper"
            >
              <h5>
              ...
              <h5>
                Apache Calcite Adapter Architecture for Efficient Query
                Federation (KCC 2023)
              </h5>
            </a>
          </div>
        ...
        <div class="row row-conf">
          <div class="col">
            <h2>CONFERENCES</h2>
            <a
              href="https://yonding.s3.ap-northeast-2.amazonaws.com/certificate2_kcc2023.pdf"
              target="_blank"
              id="kccCertificate"
            >
              <h5>2023 한국컴퓨터종합학술대회 (KCC 2023) 참석 및 발표</h5>
            </a>
          </div>
        </div>
